...
import { BarChart3, Link2, FileText, Copy, ChevronRight } from 'lucide-react'
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start mb-2">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded-full text-sm">
              <Link2 className="w-4 h-4" /> {t('geoCta.featureCsv')}
            </span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded-full text-sm">
              <FileText className="w-4 h-4" /> {t('geoCta.featureAi')}
            </span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded-full text-sm">
              <Copy className="w-4 h-4" /> {t('geoCta.featureReport')}
            </span>
          </div>
