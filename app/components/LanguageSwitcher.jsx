...
export default function LanguageSwitcher({ variant = 'cream' }) {
  ...
  const knownMultiLangPaths = ['/', '/tools', '/login', '/signup', '/privacyverklaring', '/privacy', '/dashboard', '/wordpress-plugin', '/chrome-extensie', '/chrome-extension', '/pricing', '/over-ons', '/about-us', '/updates'];
