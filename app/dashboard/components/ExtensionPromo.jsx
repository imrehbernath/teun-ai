      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-slate-600 text-sm">
            Scan je AI-zichtbaarheid direct in ChatGPT! Onze gratis Chrome extensie geeft je instant inzichten 
            terwijl je ChatGPT gebruikt. Perfect voor dagelijkse monitoring.
          </p>
        </div>
