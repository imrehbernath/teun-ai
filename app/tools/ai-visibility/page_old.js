              ...
              <div className="lg:col-span-2">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-slate-900">Analyse voltooid!</h2>
                      <p className="text-green-700">Je AI-zichtbaarheidsrapport voor {formData.companyName}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  {results.analysis_results.map((result, idx) => (
                    <div key={idx} className="bg-white hover:bg-slate-50 border border-slate-200 rounded-xl p-4 transition-all shadow-sm">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-blue-700 mb-2 font-medium">{result.ai_prompt}</p>
                          <p className="text-sm text-slate-600 leading-relaxed">{result.simulated_ai_response_snippet}</p>
                          {result.competitors_mentioned?.length > 0 && (
                            <div className="flex flex-wrap gap-2 mt-3">
                              <span className="text-xs text-slate-500">Concurrenten:</span>
                              {result.competitors_mentioned.map((comp, i) => (
                                <span key={i} className="text-xs px-2 py-1 bg-purple-50 text-purple-700 rounded-md border border-purple-200">
                                  {comp}
                                </span>
                              ))}
                            </div>
