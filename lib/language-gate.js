...
// Groepeer per land, met landnaam + bekende grote steden. Skip 2-3 letter
// afkortingen die ambigu kunnen zijn in NL/BE context.
const BLOCKED_LOCATIONS = [
  ...
  // Malaysia
  'malaysia', 'maleisie', 'malaysie',
  'kuala lumpur',
  'johor bahru', 'johor',
  'penang',
  'ipoh', 'shah alam',
  // Filipijnen
  'philippines', 'filipijnen', 'pilipinas',
  'manila', 'manilla',
  'makati', 'quezon city',
  'cebu', 'davao',
  // Pakistan
