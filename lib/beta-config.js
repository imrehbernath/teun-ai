...
export const BETA_CONFIG = {
  ...
  ADMIN_EMAILS: [
  process.env.ADMIN_EMAIL,        // ← Jouw email uit .env.local
  'colin@onlinelabs.nl',        // ← Voeg hier zijn email toe
  ].filter(Boolean),

  // ✨ NEW: Admin fast scan mode
  ADMIN_SETTINGS: {
    fastScanMode: true,        // Only scan 1 prompt instead of 5-10
    numberOfPrompts: 10,        // Number of prompts to test
    skipCooldown: true,        // No cooldown for admins
    unlimitedScans: true       // Unlimited scans
  },
