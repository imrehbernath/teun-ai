...
// ChatGPT: gpt-4o-search-preview gebruikt vrijer formaat (geen blok),
// dus we draaien direct de 5-patterns parser met strenge validatie.
export function extractCompetitorsFromChatGPT(rawOutput, companyName) {
  ...
  // Pattern 3: Bullet items with bold name + colon
